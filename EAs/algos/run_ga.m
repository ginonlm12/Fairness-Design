function [best_solution, convergence, best_obj] = run_ga(dim, obj_func, max_fes, pop_size, verbose)
    disp("GA running for maximization, generation = " + max_fes/pop_size + ", n=" + pop_size + " ...");
