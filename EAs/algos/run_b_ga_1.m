function [best_solution, convergence, best_obj] = run_b_ga_1(dim, obj_func, max_fes, pop_size, verbose)
    ...
    for it = 1:MaxIt
        ...
        for k = 1:nc/2
            ...
            % Perform Crossover
            [popc(k, 1).Position, popc(k, 2).Position] = Crossover_singlepoint_only(p1.Position, p2.Position);
