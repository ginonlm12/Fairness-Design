function RateCF = Func_RateClosedForm_Letter_(RAll,PhiMatrixS,GammaMatrixA,BETAA,LoSChannels,power_f,Pus,B,tau,tauc,K,sigma2s, sigma2a, modeS, modeA, alpha, M)
