function obj_value_0alpha = Rate1(AP,Ter,M,K,obj)
    ...
    modeS = 1; modeA =1;
    beta = ones(K,M+1);
    [~, GammaMatrixA, PhiMatrixS] =  Func_C_Gamma_Letter(M,N,K,Pua,Pus, tau, BETAA, RAll,sigma2a, sigma2s, beta);   
    RateCFwithoutalpha = Func_RateClosedForm_Letter_(RAll,PhiMatrixS,GammaMatrixA,BETAA,LoSChannels,power_f,Pus,B,tau,tauc,K,sigma2s, sigma2a, modeS, modeA, beta, M);
    end
    ...
    %obj_value = prod(RateCF);
    obj_value_0alpha = obj(RateCFwithoutalpha(:));     
